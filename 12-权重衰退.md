...
- `torch.optim.SGD`Pytorch求输入的p范数（默认为L2范数，结果均为开根号） 🧐[中文](https://pytorch-cn.readthedocs.io/zh/latest/package_references/torch/#torchnorm) | [官方英文](https://pytorch.org/docs/stable/generated/torch.norm.html?highlight=norm#torch.norm)
