...
- 所有笔记将采用**Markdown**格式进行编排,推荐使用**VSCode**来编写。
  - [Markdown 基本语法快速入门点这里](https://markdown.com.cn)
...
- **D2L课程官方文档**点击👉[此处](https://zh-v2.d2l.ai/)
...
同学们在学习的过程中，如对笔记上的记录内容有任何问题（如纠错、提问、排版、建议等），均可在本项目的Gitee主页点击`Issues`按钮，提出**Issues**进行反馈。

![](Images/create_issue.png)