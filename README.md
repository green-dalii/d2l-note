...
同学们在学习的过程中，对笔记上的内容有任何疑问（如**提问&回答**🙋‍♀️、**排版**✒、**意见建议**💬 等）欢迎在本项目的 Gitee 主页疯狂点击 🖱`Issues`按钮，提出**Issues**进行反馈，我们会尽力及时回复~

![create_issue](Images/create_issue.png)

如果觉得笔记内容有写得实在👁不顺眼、❌有错、💢瞎写的地方，欢迎**打脸纠错** 😰，撸起袖子提交**Pull Requests**进行修改，具体操作步骤可参考第三章内容 👉[Git 快速入门](03-Git快速入门.md)
